...
class NewspaperPdfPage extends Page {
    ...
    public get bookIcon() {
        return $(
            '//android.view.ViewGroup[@content-desc="Tap me to open the sections menu"]/android.view.ViewGroup/android.view.ViewGroup'
        );
    }
    ...
    public get photoImageGallery() {
        return $(
            '//android.widget.FrameLayout[@resource-id="android:id/content"]/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[1]'
        );
    }
